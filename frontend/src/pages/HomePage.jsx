...
description: "Developed EmpowerHer, an AI-powered full stack educational platform with an AI chatbot, content checker, and module generator, featuring secure authentication, role-based access, and database integration.",
image: empowerher,
tech: [
    {icon: IoLogoJavascript, name: "Javascript", style: "javascript"}, 
